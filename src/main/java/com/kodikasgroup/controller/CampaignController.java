...
public class CampaignController {
	...
	private void getallCampaign() throws IOException {
		...
		String jsonString2 = RequestMaker.sendGET(ENTITLED_ENDPOINT + "/" + URLEncoder.encode(citizen.getCategory(), StandardCharsets.UTF_8));
		...
		for (Entitled entry : entitledWrapper.getEntitles()) {
			vaccineID.add(entry.getVaccine().getVaccineID());
		}
